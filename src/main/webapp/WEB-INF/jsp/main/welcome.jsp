...
<body class="gray-bg sidebar-content">
    ...
    <div class="sidebard-panel">
        <div>
            ...
            <div class="feed-element">
                <a href="${ctx}/static/index_3.html#" class="pull-left">
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <h1 class="no-margins">60 420,600</h1>
                        <div class="stat-percent font-bold text-warning">40% <i class="fa fa-level-up"></i>
                        </div>
                        <small>新订单</small>
                    </div>
                </div>
            ...
            <div class="col-sm-6">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            ...
                            <a class="dropdown-toggle" data-toggle="dropdown" href="${ctx}/static/index_3.html#">
                                <i class="fa fa-wrench"></i>
                            </a>
                            <ul class="dropdown-menu dropdown-user">
                                <li><a href="${ctx}/static/index_3.html#">选项1</a>
                                </li>
                                <li><a href="${ctx}/static/index_3.html#">选项2</a>
                                </li>
                            </ul>
                            <a class="close-link">
                    ...
                    <div class="ibox-content">
                        <div>
                            ...
                            <div class="pull-right text-right">
                                ...
                                <span class="bar_dashboard">0,9,5,6,8,3,2,1</span>
                                <br/>
                                <small class="font-bold">$ 20 054.43</small>
                            </div>
                            <h4>广东地区的数据报告
                                    <br/>
                                    <small class="m-r"><a href="${ctx}/static/graph_flot.html"> 获取最新股票价格 </a> </small>
                                </h4>
                        </div>
                    </div>
                </div>
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content no-padding">
                        <ul class="list-group">
                            <li class="list-group-item">
                                <p><a class="text-info" href="${ctx}/static/index_3.html#">@星探子</a> 我的目标就是想做一个跟你一样有责任感，有思想，有深度的新闻媒体从业人</p>
                                <small class="block text-muted"><i class="fa fa-clock-o"></i> 1分钟前</small>
                            </li>
                            <li class="list-group-item">
                                <p><a class="text-info" href="${ctx}/static/index_3.html#">@小七是</a> 其实自己一半的大学生活也基本上是和新闻为伍了～一篇小小的稿子也许只有5、6百字，可以却可以写1、2个小时。一场会议也许3个小时，睡一觉就过去了，可是却要端着相机站3个小时，害怕错过一个经典的镜头。新闻人，更辛苦。</p>
    ...
    <!-- Jvectormap -->
    <script src="${ctx}/static/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
