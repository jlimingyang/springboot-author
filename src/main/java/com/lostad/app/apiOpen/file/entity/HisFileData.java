 ...
 */
@Entity
@Table(name = "his_file_data")
@JsonIgnoreProperties({"filePath"})
public class HisFileData extends IdAutoEntity {
    @Column(name = "download", nullable = true, columnDefinition = "tinyint(1) default 0 COMMENT '是否已下载'")
    private Integer download = 0;
    @Column(name = "report", nullable = true, columnDefinition = "tinyint(1) default 0 COMMENT '是否已出报告'")
